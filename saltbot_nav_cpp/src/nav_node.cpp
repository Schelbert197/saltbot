...
#include "saltbot_nav_cpp/srv/nav_to_pose.hpp"
...
public:
  ...
  : Node("nav_to_pose")
  {
    ...
    // Services
    srv_nav_to_pose_ = create_service<saltbot_nav_cpp::srv::NavToPose>(
      "saltbot_nav_to_pose",
    ...
    // Publishers
    pub_waypoint_goal_ = create_publisher<std_msgs::msg::String>("saltbot_goal", 10);
...
private:
  ...
  rclcpp::Service<saltbot_nav_cpp::srv::NavToPose>::SharedPtr srv_nav_to_pose_;
  ...
  std_msgs::msg::String saltbot_goal_msg_ = std_msgs::msg::String();
  ...
  void srv_nav_to_pose_callback(
    const std::shared_ptr<saltbot_nav_cpp::srv::NavToPose::Request> request,
    std::shared_ptr<saltbot_nav_cpp::srv::NavToPose::Response>
  ) {
  ...
  void result_callback(
    ...
    switch (result.code) {
      ...
      case rclcpp_action::ResultCode::ABORTED:
        ...
        saltbot_goal_msg_.data = "Aborted";
        pub_waypoint_goal_->publish(saltbot_goal_msg_);
        return;
      case rclcpp_action::ResultCode::CANCELED:
        RCLCPP_ERROR(this->get_logger(), "Goal was canceled");
        saltbot_goal_msg_.data = "Canceled";
        pub_waypoint_goal_->publish(saltbot_goal_msg_);
        return;
      default:
        RCLCPP_ERROR(this->get_logger(), "Unknown result code");
        saltbot_goal_msg_.data = "Unknown";
        pub_waypoint_goal_->publish(saltbot_goal_msg_);
        return;
    }
